/*
	...
	An example app to use as starting point for mydigitalstucture.cloud based nodejs app that will be run/hosted
	using AWS lambda.

	Once nodejs has been installed; run 'node app-1.0.0.js' using the OS terminal/console command prompt

	To run this on your local computer then install: https://www.npmjs.com/package/aws-lambda-local
